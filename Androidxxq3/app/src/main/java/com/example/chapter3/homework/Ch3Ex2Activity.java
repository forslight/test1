...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2_1=ObjectAnimator.ofFloat(target,"scaleX",1f,2f);
        animator2_1.setDuration(1000);
        animator2_1.setRepeatCount(ObjectAnimator.INFINITE);
        animator2_1.setRepeatMode(ObjectAnimator.REVERSE);
        ObjectAnimator animator2_2=ObjectAnimator.ofFloat(target,"scaleY",1f,2f);
        animator2_2.setDuration(1000);
